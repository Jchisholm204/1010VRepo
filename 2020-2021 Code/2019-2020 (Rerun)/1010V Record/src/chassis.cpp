...
void Chassis::OP_Chassis(void){
  int Y1 = exponential((master.get_analog(E_CONTROLLER_ANALOG_LEFT_Y) *0.9), 1.5 /*DriveExp*/, 8 /*JoyDead*/, 15 /*MotorMin*/);
	int X1 = exponential((master.get_analog(E_CONTROLLER_ANALOG_RIGHT_X) *0.9), 1.5 /*DriveExp*/, 8 /*JoyDead*/, 15 /*MotorMin*/);
	int Z1 = exponential((master.get_analog(E_CONTROLLER_ANALOG_LEFT_X) *0.9), 1.5 /*DriveExp*/, 8 /*JoyDead*/, 15 /*MotorMin*/);
